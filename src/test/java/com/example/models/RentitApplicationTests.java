...
public class RentitApplicationTests {
	...
	// @Test
	// public void getRentalAvailabilityForRental(String name, BusinessPeriod
	// period) {
	// repo.findAll(nameContains(name).and(isAvailableFor(period)));
	// }
	//
	// //Query the list of plants that have not been hired during the last 6
	// months
	// @Test
	...
	// }
	//
	// //Compute the cost due to corrective repairs per year for the last 5
	// years
	// @Test
